...
namespace Devolon\PaymentHighway\Tests;

use Devolon\Payment\DevolonPaymentServiceProvider;
use Devolon\PaymentHighway\DevolonPaymentHighwayServiceProvider;
...
abstract class PaymentHighwayTestCase extends TestCase
{
    use RefreshDatabase;
    ...
    {
        return [DevolonPaymentServiceProvider::class, DevolonPaymentHighwayServiceProvider::class];
    }
