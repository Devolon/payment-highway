...
class PaymentHighwayGatewayTest extends PaymentHighwayTestCase
{
    use WithFaker;
    ...
    public function testGetName()
    {
        ...
        // Assert
        $this->assertEquals('payment-highway', $result);
    }
    ...
    public function testItRegisteredAsGateway()
    {
        ...
        // Act
        $result = $paymentGatewayDiscoveryService->get('payment-highway');

        // Assert
        $this->assertInstanceOf(PaymentHighwayGateway::class, $result);
    ...
    private function resolveGateway(): PaymentHighwayGateway
    {
        return resolve(PaymentHighwayGateway::class);
    }
    ...
    private function discoverGateway(): PaymentGatewayInterface
    {
        ...
        return $paymentDiscoveryService->get('payment-highway');
    }
